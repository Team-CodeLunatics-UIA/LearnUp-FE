...
const SchoolOverview = () => {
  ...
  const [tasks, setTasks] = useState([
    ...
    {
      content: "Approve School Fundings",
      priority: "New",
      color: "#29cc97",
    },
    {
    ...
    <div className={styles.dashboardContainer}>
      <div className={styles.stats_container}>
        <div className={styles.stats}>
          <p className={styles.clrGrey}>Enrollments Per Month</p>
      ...
      <div className={styles.graphs_charts_Container}>
        <div className={styles.graphContainer}>
          <div className={styles.sectionHeader}>
            <div className={styles.titleSubtitle}>
              <p className={styles.sectionTitle}>This month's Trends</p>
              <p className={styles.sectionSubTitle + " " + styles.clrGrey}>
                Funds Allocated (in Lacs) v/s Institutes Developed (As of 25 May 2022)
              </p>
            </div>
        ...
        <div className={styles.graphChartsContainer}>
          <div className={styles.chart + " " + styles.noTopBorder}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Gross Enrollments</p>
            <p className={styles.chart_number}>{charts.consignmentsReceived}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Successful Passouts</p>
            <p className={styles.chart_number + " " + styles.clrGreen}>{charts.safeDeliveries}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Students Achievements</p>
            <p className={styles.chart_number + " " + styles.clrBlue}>{charts.anamoliesDetected}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Curriculum Responses</p>
            <p className={styles.chart_number + " " + styles.clrRed}>{charts.anamoliesForwarded}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Teacher Needing Training</p>
