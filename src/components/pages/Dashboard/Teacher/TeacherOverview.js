    ...
    <div className={styles.dashboardContainer}>
      ...
      <div className={styles.graphs_charts_Container}>
        ...
        <div className={styles.graphChartsContainer}>
          ...
          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Mapped Institutes</p>
            <p className={styles.chart_number + " " + styles.clrBlue}>{charts.anamoliesDetected}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>UnMapped Institutes</p>
            <p className={styles.chart_number + " " + styles.clrRed}>{charts.anamoliesForwarded}</p>
          </div>

          <div className={styles.chart}>
            <p className={styles.chartTitle + " " + styles.clrGrey}>Funds Approved</p>
